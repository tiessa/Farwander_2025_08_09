namespace TJNK.Farwander.Modules.Game
{
    ...
    // AI
    public struct AI_TurnStart { public int TurnIndex; }
    public struct AI_MoveIntent { public int EntityId; public Direction8 Dir; }

    // FOV
    public struct Fov_Recompute { public int ViewerId; public int Radius; }
    public struct Fov_Updated { }

    // Items/Inventory (reserved)
